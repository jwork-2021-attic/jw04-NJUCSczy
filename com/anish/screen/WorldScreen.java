...
import com.anish.monster.BubbleSorter;
import com.anish.monster.Calabash;
import com.anish.monster.Monster;
import com.anish.monster.QuickSorter;
import com.anish.monster.World;
...
public class WorldScreen implements Screen {
    ...
    public WorldScreen() {
        world = new World();
        Monster.init_monsters(world);
        Monster _monsters[]=new Monster[256];
        for(int i=0;i<256;i++){
            _monsters[i]=Monster.get_monsters()[i/16][i%16];
        }
    ...
    private Monster getBroByRank(Monster[][] monsters, int rank) {
        for (Monster[] _monsters : monsters) {
    ...
    public Screen respondToUserInput(KeyEvent key) {
        ...
        if (i < this.sortSteps.length) {
            ...
            this.execute(Monster.get_monsters(), sortSteps[i]);
            i++;
        }
